...
python ../Code/generate_adversarials.py --model_path PM --adversary_path_x ADX.npy --adversary_path_y ADY.npy --fgsm_eps $epsilon >> ../Data/AdvOutputs/$epsilon/log
...
mv BM ../Data/AdvOutputs/$epsilon/
mv PM ../Data/AdvOutputs/$epsilon/
