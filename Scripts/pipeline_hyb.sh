...
# Train proxy model
python ../Code/train_model.py --is_blackbox False --save_here PM --is_autoencoder 3 --batch_size 16 --learning_rate 0.01 --nb_epochs 500 >> ../Data/CNNSVM/$epsilon/log
# Generate adversarial examples for proxy model
python ../Code/generate_adversarials.py --model_path PM --adversary_path_x ADX.npy --adversary_path_y ADY.npy --fgsm_eps $epsilon >> ../Data/CNNSVM/$epsilon/log
...
#mv BM ../Data/CNNSVM/$epsilon/
#mv PM ../Data/CNNSVM/$epsilon/
...
#mv C.pkl ../Data/CNNSVM/$epsilon/
#mv arch.json ../Data/CNNSVM/$epsilon/
