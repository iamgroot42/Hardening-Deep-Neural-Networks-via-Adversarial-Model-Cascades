...
python ../Code/train_model.py --is_blackbox True --save_here BM --specialCNN sota --retraining True --batch_size 16 --learning_rate 0.0001 --nb_epochs 75 >> ../Data/IntelliCNN/$epsilon/log
