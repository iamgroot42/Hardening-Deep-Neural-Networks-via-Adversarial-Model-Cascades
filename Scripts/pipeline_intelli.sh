...
python ../Code/generate_adversarials_fgsm.py --model_path BM --adversary_path_x PX.npy --adversary_path_y PY.npy --fgsm_eps $epsilon >> ../Data/IntelliCNN/$epsilon/log
# Finetune blackbox model using adversarial data
python ../Code/train_model.py --is_blackbox True --save_here BM --specialCNN sota --retraining True --batch_size 16 --learning_rate 0.0001 --nb_epochs 70 >> ../Data/IntelliCNN/$epsilon/log
...
# Train proxy model
python ../Code/train_model.py --is_blackbox False --save_here PM --batch_size 16 --learning_rate 0.005 --nb_epochs 200 >> ../Data/IntelliCNN/$epsilon/log
# Generate adversarial examples for proxy model
python ../Code/generate_adversarials_fgsm.py --model_path PM --adversary_path_x ADX.npy --adversary_path_y ADY.npy --fgsm_eps $epsilon >> ../Data/IntelliCNN/$epsilon/log
