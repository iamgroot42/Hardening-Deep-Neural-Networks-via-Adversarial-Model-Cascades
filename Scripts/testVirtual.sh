...
python ../Code/virtual.py --gamma $gamma --model_path $ppmodel --dataset $dataset --adversary_path_x $prefix"X" --adversary_path_y $prefix"Y" --num_iters $num_iters --xi $xi --eps $eps
