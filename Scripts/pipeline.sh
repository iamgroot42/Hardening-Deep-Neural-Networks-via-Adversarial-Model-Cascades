...
python ../Code/train_model.py --is_blackbox True --save_here BM --specialCNN normal >> ../Data/VanillaCNN/$epsilon/log
...
# Train proxy model
python ../Code/train_model.py --is_blackbox False --save_here PM >> ../Data/VanillaCNN/$epsilon/log
