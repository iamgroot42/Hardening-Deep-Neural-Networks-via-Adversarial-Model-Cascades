...
from keras.layers import Conv2D, MaxPooling2D, AtrousConvolution2D, SeparableConvolution2D, AveragePooling2D, Dense, Dropout, Activation, Flatten
...
def proxy(n_classes=10, mnist=False, learning_rate=1e-1):
	...
	if mnist == True:
		img_input = (28, 28, 1)
	model = Sequential()
	model.add(Conv2D(32, 3, 3, border_mode='same', W_regularizer=l2(0.0001), init=he_normal(), input_shape=img_input))
