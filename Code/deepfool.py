...
def main(argv=None):
	...
	deepfool = DeepFool(model, sess=keras.backend.get_session())
	adv_x = deepfool.generate_np(X, clip_min=0.0, clip_max=1.0, nb_candidate=Y.shape[1], max_iter=FLAGS.iters)
